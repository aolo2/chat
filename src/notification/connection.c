...
connection_get(struct bc_notifier *server, int connection_socket)
{
...
static struct bc_connection *
connection_create(struct bc_notifier *server, int socket)
{
...
static bool
connection_init(struct bc_notifier *server, const char *port)
{
...
static bool
connection_remove(struct bc_notifier *server, int socket)
{
...
static void
connection_drop(struct bc_notifier *server, struct bc_connection *connection)
{
